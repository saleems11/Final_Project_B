def save_history_data(tweet_length, epoch, batch_size, drop_out, bi_lstm_hidden_state_size,
                      history, learning_rate, embedding_size, score, iteration_number, fully_connected_layer):
    ...
    file.write("-- tweet len:{0}, epochs:{1}, batch_size={2}, drop_out={3}, bi_lstm_hidden_state_size:{4}"
               ...
               "The Silhouette score: {9}, iteration number: {10}, fully connected layer: {11}\n".format(
        ...
        learning_rate,
        embedding_size, score, iteration_number, fully_connected_layer))
    file.close()